...
export const Play = ({ size = 14, color = "currentColor" }: { size?: number; color?: string }) => (
...
export const Stop = ({ size = 13, color = "currentColor" }: { size?: number; color?: string }) => (
  <svg width={size} height={size} viewBox="0 0 14 14" fill="none">
    <rect x="1.8" y="1.8" width="10.4" height="10.4" rx="2.5" stroke={color} strokeWidth="1.8" />
  </svg>
);

export const Folder = ({ size = 19, color = "currentColor" }: { size?: number; color?: string }) => (
...
export const FileIcon = ({ size = 12, color = "currentColor" }: { size?: number; color?: string }) => (
...
export const Redo = ({ size = 15, color = "currentColor" }: { size?: number; color?: string }) => (
...
export const Pencil = ({ size = 16, color = "currentColor" }: { size?: number; color?: string }) => (
...
export const X = ({ size = 15, color = "currentColor" }: { size?: number; color?: string }) => (
...
export const Box = ({ checked, accent, dashed }: { checked?: boolean; accent?: boolean; dashed?: boolean }) => (
  <svg width="17" height="17" viewBox="0 0 17 17" fill="none" style={{ flex: "none" }}>
    <rect
      ...
      height="14"
      rx="3"
      stroke={accent ? "var(--accent)" : dashed ? "var(--muted)" : "var(--ink)"}
      strokeWidth={accent ? 1.7 : 1.5}
      strokeDasharray={dashed ? "3 3" : undefined}
    />
    {checked && <path d="M4 8.5 C 6 10, 7 11.5, 7.5 12.5 C 9 9, 11 5.5, 14 3.5" stroke="var(--ink)" strokeWidth="1.8" strokeLinecap="round" />}
  </svg>
);
